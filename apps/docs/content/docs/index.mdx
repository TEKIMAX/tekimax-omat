---
title: Introduction
description: Open-source AI infrastructure for organizations building software for good.
---
...
<div className="flex items-center gap-4 not-prose mb-8">
  ...
  <div className="flex flex-col">
    <span className="text-xl font-bold">Open AI infrastructure for the public good</span>
